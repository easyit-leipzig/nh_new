/* Wissenswertes: Mobilmenü, Menüblätterung und aktive Zielgruppe */
...
const audienceLinks = [
  ...document.querySelectorAll(
    '.audience-switcher a, .knowledge-subnav a'
  )
];

const audienceSections = [
  ...document.querySelectorAll(".knowledge-audience[id]")
];
...
audienceSections.forEach(section => audienceObserver.observe(section));
