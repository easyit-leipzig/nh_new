/* Methodik: Mobilmenü, Menüblätterung und aktive Abschnittsanzeige */
...
const subnavLinks = [...document.querySelectorAll(".method-subnav a")];
const methodSections = [
  ...document.querySelectorAll(
    "#grundidee, #alleinstellungsmerkmale, #ablauf, #nachweise, #wirkung"
  )
];
...
methodSections.forEach(section => sectionObserver.observe(section));
